...
public class ShellCommand {
    ...
    public String[] start(boolean waitForExit) {
        MyLog.d(7, "ShellCommand: starting [" + tag + "] " + Arrays.toString(command));
    ...
    public void finish() {
        MyLog.d(2, "ShellCommand: finishing [" + tag + "] " + Arrays.toString(command));
    ...
    public boolean sendCommand(String command) {
        if (MyLog.enabled) {
            if (!command.equals("echo;echo ..EOF..$?\n")) {
                MyLog.d(10, "ShellCommand [" + tag + "] Executing command [" + command.trim() + "]");
            }
        }
